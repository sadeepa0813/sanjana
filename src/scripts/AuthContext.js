...
class AuthContext {
    ...
    async init() {
        ...
        supabase.auth.onAuthStateChange(async (event, session) => {
            ...
            if (session?.user) {
                ...
                // Force redirect if on protected page and not logged in
                const currentPath = window.location.pathname;
                if (currentPath.includes('admin.html') || currentPath.includes('user-dashboard.html')) {
    ...
    /**
     * Update Global State (Removed window props for security)
     */
    updateGlobalState() {
